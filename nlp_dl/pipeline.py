...
# -*- coding:utf-8 -*-
'''
Main Pipiline Access for nlp_dl modules, Loading all pre-trained models during initilization
@author: xichen ding
@date: 2016/10/9
'''
...
from nlp_dl import segmenter as segmenter     # segmenter module
from nlp_dl import pos_tagger as pos_tagger   # pos tagger
from nlp_dl import ner_tagger as ner_tagger   # ner tagger
